...
// PaymentMethod определяет способы оплаты заказов.
...
// PayOrderRequest содержит информацию для обработки платежа.
...
// PayOrderResponse содержит идентификатор созданной транзакции.
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB\xbb\x01\n" +
	"\x0ecom.payment.v1B\fPaymentProtoP\x01ZRgithub.com/yourusername/microservices-course/shared/pkg/proto/payment/v1;paymentv1\xa2\x02\x03PXX\xaa\x02\n" +
	"Payment.V1\xca\x02\n" +
