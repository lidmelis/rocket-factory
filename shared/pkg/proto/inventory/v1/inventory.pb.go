...
// Category определяет категории деталей для космических кораблей.
type Category int32
...
// GetPartRequest содержит UUID детали для получения.
type GetPartRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Uuid          string                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"` // Идентификатор детали
...
// GetPartResponse содержит информацию о запрошенной детали.
type GetPartResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Part          *Part                  `protobuf:"bytes,1,opt,name=part,proto3" json:"part,omitempty"` // Информация о детали
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// ListPartsRequest содержит фильтр для поиска деталей.
type ListPartsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Filter        *PartsFilter           `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"` // Фильтр для поиска деталей
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListPartsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Parts         []*Part                `protobuf:"bytes,1,rep,name=parts,proto3" json:"parts,omitempty"` // Список деталей
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// PartsFilter позволяет фильтровать детали по различным критериям.
type PartsFilter struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	Uuids                 []string               `protobuf:"bytes,1,rep,name=uuids,proto3" json:"uuids,omitempty"`                                                              // Список UUID'ов для фильтрации
	Names                 []string               `protobuf:"bytes,2,rep,name=names,proto3" json:"names,omitempty"`                                                              // Список имён для фильтрации
	Categories            []Category             `protobuf:"varint,3,rep,packed,name=categories,proto3,enum=inventory.v1.Category" json:"categories,omitempty"`                 // Список категорий для фильтрации
	ManufacturerCountries []string               `protobuf:"bytes,4,rep,name=manufacturer_countries,json=manufacturerCountries,proto3" json:"manufacturer_countries,omitempty"` // Список стран производителей для фильтрации
	Tags                  []string               `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty"`                                                                // Список тегов для фильтрации
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
// Part представляет информацию о детали для космического корабля.
type Part struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	...
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`                                                        // Дата создания записи
	UpdatedAt     *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`                                                        // Дата обновления записи
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Dimensions содержит размерные характеристики детали.
...
// Value представляет значение в метаданных детали.
type Value struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB\xcb\x01\n" +
	"\x10com.inventory.v1B\x0eInventoryProtoP\x01ZVgithub.com/yourusername/microservices-course/shared/pkg/proto/inventory/v1;inventoryv1\xa2\x02\x03IXX\xaa\x02\fInventory.V1\xca\x02\fInventory\\V1\xe2\x02\x18Inventory\\V1\\GPBMetadata\xea\x02\rInventory::V1b\x06proto3"
